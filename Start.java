...
public class Start{
		...
		FileReadWriteDemo frwd = new FileReadWriteDemo();
                 ...
                 switch(choice11)
                {
                  case 1 :
                          ...
                          if(userName.equals(r.userName) && pass.equals(r.pass))
                          {
  ...
  else if(r.userName==null && r.pass == null)
    {
        System.out.println("Please register first for log in ! ");   

    }
    else if(userName != (r.userName) && pass.equals(r.pass) )
    {
        System.out.println(" Incorrect Username  "); 
    }
    else if(userName.equals(r.userName) && pass != (r.pass) )
    {
    ...
    break;
     ...
     pass1 = sc.next();
         if (pass.equals(pass1))
         {
             ...
             System.out.println("Your registration was successsful !!!");
        }
                        else{
                            System.out.println("Incorrect comfirm password");
                            }

                    

				}
                        System.out.println("Go back to the main menu ? type 1 for yes & type 2 for no .");
                        menu = sc.nextInt();
                    }while(menu == 1);   
